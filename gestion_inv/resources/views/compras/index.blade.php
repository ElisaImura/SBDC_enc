                ...
                <div class="col-md-5">
                    ...
                    <div class="container">
                        <form id="form-concretarCompra" method="post" action="{{ route('compras.concretarCompra') }}">
                            ...
                            <button type="submit" class="btn btnAccion">Concretar compra</button>
                        </form>
                      </div>
                </div>
                                            ...
                                            <td class="text-center botones" id="btn-pro">
                                                <div class="row justify-content-center">
                                                    <div class="col-4 col-btn align-middle">
                                                        <form action="{{ route('compras.destroy', ['temp_id' => $dcompra->temp_id]) }}" method="POST" id="formEliminarCompra-{{ $dcompra->temp_id }}" data-id="{{ $dcompra->temp_id }}" style="margin: 0px;">
                                                            @csrf
                                                            @method('DELETE')
                                                            <button type="button" class="btn btnEliminar btnEliminarCompra" id="btnEliminarCompra-{{ $dcompra->temp_id }}">
                                                    ...
                                                    <div class="col-4 col-btn align-middle">
                                                        <a href="{{ route('compras.edit', ['temp_id' => $dcompra->temp_id]) }}" class="btn btnEditar">
