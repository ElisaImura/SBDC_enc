                                        ...
                                        <td>{{ $dcompra->dcompra_precio }}</td>
                                            <td class="text-center">
                                                <div id="btn-pro" class="botones">
                                                    <form action="{{ route('ventas.destroy', ['temp_id' => $dcompra->temp_id]) }}" method="POST" id="formEliminarVenta-{{ $dcompra->temp_id }}" data-id="{{ $dcompra->temp_id }}">
                                                        @csrf
                                                        @method('DELETE')
                                                    ...
                                                    <form action="{{ route('ventas.edit', ['temp_id' => $dcompra->temp_id]) }}">                                   
