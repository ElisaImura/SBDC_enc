                                            ...
                                            <td class="text-center botones" id="btn-pro">
                                                <div class="row justify-content-center">
                                                    <div class="col-4 col-btn">
                                                        <form action="{{ route('presupuesto.destroy', ['temp_id' => $dventa->temp_id]) }}" method="POST" id="formEliminarVenta-{{ $dventa->temp_id }}" data-id="{{ $dventa->temp_id }}" style="margin: 0px;">
                                                            @csrf
                                                            @method('DELETE')
                                                    ...
                                                    <a href="{{ route('presupuesto.edit', ['temp_id' => $dventa->temp_id]) }}" class="btn btnAccion">
                            ...
                            <div class="row justify-content-between" style="padding: 0px 10px;">
                                ...
                                <div class="col-md-4 d-flex justify-content-end">
                                    <form method="post" action="{{ route('presupuesto.reiniciar') }}">
                                        @csrf
                                        <button type="submit" class="btn btnAccion">Reiniciar</button>
                                    </form>
